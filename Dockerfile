...
CMD ["java", "-cp", "/usr/local/docker-git-hello-world/target/docker-git-hello-world-1.0-SNAPSHOT-jar-with-dependencies.jar", "com.makschornyi.docker.HelloWorldPing"]